...
export class HeaderComponent implements OnInit {
  ...
  public cityName: string = "All Cities";
  ...
  logged: string = "";
  public loggedIn(success:string){
    this.logged = success;
  }

  displayInfo:string = "";
  public showUserInfo(showInfo:string){
    ...
    this.menuArr = [
      ...
      },
      {
        id: "classified", name: "Classified", subMenu: [
          ...
          // {
          //   id: "Toy", name: "Toys", child: [
          //     { id: "ElectRemote", name: "Electronic & Remote Control Toys" },
          //     { id: "ActionToy", name: "Action Figures & Toy Vehicles" },
          //     { id: "OutdoorStrut", name: "Outdoor Toys & Structures" },
          //     { id: "Hobbies", name: "Hobbies" },
          //     { id: "PlayToys", name: "Pretend Play & Preschool Toys" },
          //     { id: "EduToys", name: "Educational Toys" },
          //     { id: "DollStuff", name: "Dolls & Stuffed Animals" },
          //     { id: "GamePuzzle", name: "Games & Puzzles" },
          //     { id: "ClassicVintage", name: "Classic & Vintage Toys" },
          //     { id: "BuildingToys", name: "Building Toys" },
          //     { id: "Other", name: "Other" }
          //   ]
          // },
          // {
          //   id: "TicVoucher", name: "Tickets & Vouchers", child: [
          //     { id: "Concerts", name: "Concerts" },
          //     { id: "SportEvents", name: "Sporting Events" },
          //     { id: "Travel", name: "Travel" },
          //     { id: "Events", name: "Events" },
          //     { id: "Movies", name: "Movies" },
          //     { id: "Theater", name: "Theater" },
          //     { id: "ActAttr", name: "Activities & Attractions" },
          //     { id: "VouchGift", name: "Vouchers & Gift Cards" },
          //     { id: "Other", name: "Other" }
          //   ]
          // },
          // {
          //   id: "Collectible", name: "Collectibles", child: [
          //     { id: "Antiques", name: "Antiques" },
          //     { id: "Art", name: "Art" },
          //     { id: "Decorations", name: "Decorations" },
          //     { id: "PensWriting", name: "Pens & Writing Instruments" },
          //     { id: "Memorabilia", name: "Memorabilia" },
          //     { id: "RocksArtifacts", name: "Rocks/Fossils/Artifacts" },
          //     { id: "Other", name: "Other" }
          //   ]
          // },
          // {
          //   id: "Book", name: "Books", child: [
          //     { id: "Textbooks", name: "Textbooks" },
          //     { id: "Nonfiction", name: "Nonfiction" },
          //     { id: "Fiction", name: "Fiction" },
          //     { id: "ChildBooks", name: "Children\'s Books" },
          //     { id: "BookAcc", name: "Book Accessories" },
          //     { id: "DEbooks", name: "Digital/E-books" },
          //     { id: "Audiobooks", name: "Audiobooks" }
          //   ]
          // },
          // {
          //   id: "Music", name: "Music", child: [
          //     { id: "Vinyl", name: "Vinyl" },
          //     { id: "CDs", name: "CDs" },
          //     { id: "Casettes", name: "Casettes" },
          //     { id: "Digital", name: "Digital" }
          //   ]
          // },
          // {
          //   id: "FreeStuff", name: "Free Stuff", child: [
          //     { id: "FHGarden", name: "Furniture, Home & Garden" },
          //     { id: "HomeApp", name: "Home Appliances" },
          //     { id: "Baby", name: "Baby Items" },
          //     { id: "Electronics", name: "Electronics" },
          //     { id: "ClothingAcc", name: "Clothing & Accessories" },
          //     { id: "Books", name: "Books" },
          //     { id: "SportsEquip", name: "Sports Equipment" },
          //     { id: "Other", name: "Other" },
          //   ]
          // },
          // {
          //   id: "LostFound", name: "Lost/Found", child: [
          //     { id: "Lost", name: "Lost" },
          //     { id: "Found", name: "Found" }
          //   ]
          // },
          // {
          //   id: "DVD", name: "DVDs & Movies", child: [
          //     { id: "DVD", name: "DVD" },
          //     { id: "Digital", name: "Digital" },
          //     { id: "VHS", name: "VHS" },
          //     { id: "OtherFormats", name: "Other Formats" }
          //   ]
          // }
        ]
      },
