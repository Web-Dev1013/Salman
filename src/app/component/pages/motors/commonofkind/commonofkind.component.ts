...
import { Motor_Product } from "./commonofkind.model";
...
export class CommonofkindComponent implements OnInit {
  product: any;
  show_case: boolean = false;
  show_productList: boolean = true;
  cat_id: string = "";
  Products: any[] = [];
  constructor(public location: Location, private router: Router) { }
  ngOnInit(): void {
    this.cat_id = this.location.prepareExternalUrl(this.location.path());
    this.cat_id = this.cat_id.slice(8);
    console.log(this.cat_id)
    switch (this.cat_id) {
      case "usedCar":
        this.Products = this.UsedCar_Products;
        break;
      case "motorcycle":
        this.Products = this.MotorCycle_Products;
        break;
      case "accessories":
        this.Products = this.Accessories_Products;
        break;
      case "heavyVehicles":
        this.Products = this.Vehicles_Products;
        break;
      case "boats":
        this.Products = this.Boats_Products;
        break;
      case "numberPlates":
        this.Products = this.Number_Plats_Products;
        break;
      case "usedCar/1":
        this.Products = this.Number_Plats_Products;
        break;
  ...
  public gotoProductDetail(Product: Motor_Product) {
    this.product = Product;
    this.show_case = true;
    this.show_productList = false;
    console.log("adfadsfasdfasd");
  }

  public UsedCar_Products: Motor_Product[] = [
  ...
  public MotorCycle_Products: Motor_Product[] = [
  ...
  public Accessories_Products: Motor_Product[] = [
  ...
  public Vehicles_Products: Motor_Product[] = [
  ...
  public Boats_Products: Motor_Product[] = [
  ...
  public Number_Plats_Products: Motor_Product[] = [
