...
exports.PickCategoryComponent = void 0;
var core_1 = require("@angular/core");
var PickCategoryComponent = /** @class */ (function () {
    function PickCategoryComponent() {
        this.showJobItem = true;
        this.hideJobItem = false;
    }
    PickCategoryComponent.prototype.ngOnInit = function () {
        this.categories = [
    ...
    PickCategoryComponent.prototype.toggleJobItem = function () {
        this.showJobItem = false;
        this.hideJobItem = true;
    };
    PickCategoryComponent = __decorate([
        core_1.Component({
    ...
    return PickCategoryComponent;
}());
exports.PickCategoryComponent = PickCategoryComponent;
