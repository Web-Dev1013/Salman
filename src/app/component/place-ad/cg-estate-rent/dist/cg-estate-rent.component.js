...
exports.CgEstateRentComponent = void 0;
var core_1 = require("@angular/core");
var CgEstateRentComponent = /** @class */ (function () {
    function CgEstateRentComponent() {
    ...
    CgEstateRentComponent.prototype.ngOnInit = function () {
    };
    CgEstateRentComponent.prototype.showDropdown = function (dropdown_id) {
        this.toggle_dropdown = dropdown_id;
    };
    CgEstateRentComponent.prototype.hideDropdown = function () {
        this.toggle_dropdown = "";
    };
    CgEstateRentComponent = __decorate([
        core_1.Component({
            selector: 'app-cg-estate-rent',
            templateUrl: './cg-estate-rent.component.html',
            styleUrls: ['./cg-estate-rent.component.css']
        })
    ], CgEstateRentComponent);
    return CgEstateRentComponent;
}());
exports.CgEstateRentComponent = CgEstateRentComponent;
